...
public class LeagueObject {
	...
	public String validate() {
    	...
    	if(isCoachDetailsEmptyOrNull()){
    		...
    		return "Attribute of coach are Empty";
		}
	...
	public boolean isCoachDetailsEmptyOrNull() {
		...
		Boolean emptyOrNull = freeCoach.stream().anyMatch(v -> v.getName() == null || v.getName().isEmpty()
		|| v.getSkating() == 0 || v.getShooting() == 0 || v.getChecking() == 0 || v.getSaving() == 0);
